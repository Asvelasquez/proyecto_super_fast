...
namespace Utilitarios
{
    ...
    public class UPedido
    {
        ...
        private List<UDetalle_pedido> compras;
        private List<UDetalle_pedido> compras1;
        ...
        [NotMapped]
        public List<UDetalle_pedido> Compras { get => compras; set => compras = value; }
        [NotMapped]
        public List<UDetalle_pedido> Compras1 { get => compras1; set => compras1 = value; }
        [NotMapped]
